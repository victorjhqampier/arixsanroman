...
class Serv_pdf_certification extends FPDF{
    ...
    function tableDatos($array_data){
        ...
        $this->Cell(25, 5.5, 'N. Certificado', 1, 0, 'C', true);
        $this->Cell(35, 5.5, $array_data['ncertificado'], 1, 1, 'C', false);      

        $this->Cell(80, 5.5, 'EMPRESA', 1, 0, 'C', true);
        $this->Cell(25, 5.5, 'RUC', 1, 0, 'R', true);
        $this->Cell(35, 5.5, $array_data['ruc'], 1, 1, 'C', false);
        ...
        //$this->Cell(25, 5.5, 'DNI', 1, 0, 'C', true);
        $this->Cell(140, 5.5, 'PROPIETARIO', 1, 0, 'C', true);
        ...
        //$this->Cell(25, 5.5, 'DNI', 1, 0, 'C', true);
        $this->Cell(140, 5.5, 'CONDUCTOR', 1, 0, 'C', true);
        ...
        $this->Cell(105, 5.5, utf8_decode('VEHÍCULO'), 1, 0, 'C', true);
