...
<div class="row">
         <div class="col-xl-12 col-md-12 mt-2">
            <div class="table-responsive-md">
               <table class="table table-sm" id="dataTable-licPorImpresas">
                  <thead>
                     <tr>
                        <th scope="col">ID</th>
...
//$(document).ready(function(){
    arixshell_iniciar_llaves_locales("#btn_id_waitprint");
    arixshell_cargar_botones_menu('btn-imprimir');
    $(arixshell_cargar_llave_local(0)).on("click", ".btn-imprimir", function() {
        alert('MARON aui dentra tu parte del sistema')
    ...
    $('#dataTable-licPorImpresas').DataTable({
      "language": {
        ...
        "ajax": {
            ...
            "dataSrc":"",
            "type": "POST",
            "data": {"txtdata" : "54F747562B763MTFiV3FCR0V0S2NHQVhJSEdRb3FlZz09"}
        },
        "columns":[
            {"data": 'axlicid'},
            {"data": 'fregistro'},
