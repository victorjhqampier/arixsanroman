            ...
            <div class="card-group">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <select class="selectpicker" multiple name="txtpermisos">
                        ...
                        <div class="form-group input-group-sm">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" id="input-read" name="txtRead" class="form-check-input" value="1" checked disabled />
                                    Puede Ver
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" id="input-write" name="txtWrite" class="form-check-input" value="0" />
                                    Puede Crear
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" id="input-update" name="txtUpdate" class="form-check-input" value="0" />
                                    Puede Actualizar
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" id="input-delete" name="txtDelete" class="form-check-input" value="0" />
                                    Puede Eliminar
                                </label>
                            </div>
                        </div>
