...
<script type="text/javascript">
    (function(){
        ...
        for(i=0;i<roles[2].length;i++){
            $('#form-axuser-add #user-sucursales').append('<div class="form-group row input-group-sm"><input type="hidden" class="d-none" name="txtusersucuid_'+i+'" value="'+roles[2][i].axuidemp+'" readonly><div class="col-sm-4"><select id="user-sucu-'+i+'" name="txtusersucuacssid_'+i+'" class="form-control form-control-sm mt-2"><option value="7F775B1A70BE2bUJseTNVaGhsZEl3SVpoOXVOOUtvUT09">Denegar</option><option value="54F747562B763N0twL3NoSXp0ZmJaSElYYVM5Mi9SUT09">Permitir</option></select></div><label for="user-sucu-'+i+'" class="col-sm-8 col-form-label"><strong>'+roles[2][i].datas+'</strong></label></div>');
        }
